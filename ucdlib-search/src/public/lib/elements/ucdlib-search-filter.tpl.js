...
return html`
  <button
    class="btn btn--alt btn--block btn--lg panel--mobile-collapse o-box toggle-button"
    @click=${this._onVisibilityClick}
    aria-expanded=${this.showOnMobile ? 'true' : 'false'}
    aria-controls="filters-main">
    Filter Results
  </button>
  <div class="light-blue main ${this.showOnMobile ? 'show': 'hide'}" id='filters-main'>
    <form @submit="${this._onSubmit}">
      ...
      <select id="sort" @input=${this._onSortInput}>
